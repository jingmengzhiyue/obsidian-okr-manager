...
const messages: Record<SupportedLocale, Record<string, string>> = {
	en: {
		...
		"actions.open": "Open",
		"actions.periodReviews": "Period reviews",
		"actions.writeRetrospective": "Write retrospective",
		"actions.createReview.weekly": "New weekly review",
		"actions.createReview.mid-cycle": "New mid-cycle review",
		"actions.createReview.retrospective": "New retrospective",
		"common.listSeparator": ", ",
		"detail.weight": "Weight / share",
		"detail.health": "Health",
		"modals.fields.weight": "Relative weight",
		"modals.input.weightError": "Weight must be a number greater than 0",
		"health.weightShort": "W",
		"health.noRiskSignals": "No active risk signals",
		"health.status.on-track": "On track",
		"health.status.at-risk": "At risk",
		"health.status.off-track": "Off track",
		"health.status.not-applicable": "N/A",
		"health.reason.behind-schedule": "Progress is behind the expected schedule",
		"health.reason.medium-confidence": "Confidence is medium",
		"health.reason.low-confidence": "Confidence is low",
		"health.reason.blocked": "The latest check-in reports a blocker",
		"health.reason.on-hold": "Work is on hold",
		"health.reason.overdue": "The due date has passed",
		"review.type.weekly": "Weekly review",
		"review.type.mid-cycle": "Mid-cycle review",
		"review.type.retrospective": "Cycle retrospective",
		"review.section.summary": "Summary",
		"review.section.wins": "Wins",
		"review.section.blockers": "Blockers",
		"review.section.next-steps": "Next steps",
		"review.section.achievements": "Achievements",
		"review.section.risks": "Risks",
		"review.section.adjustments": "Adjustments",
		"review.section.decisions": "Decisions",
		"review.section.outcomes": "Outcomes",
		"review.section.worked": "What worked",
		"review.section.did-not-work": "What did not work",
		"review.section.lessons": "Lessons learned",
		"review.section.follow-ups": "Follow-up actions",
		"review.placeholder.summary": "Summarize the current state and key context.",
		"review.placeholder.wins": "What meaningful progress was made?",
		"review.placeholder.blockers": "What is slowing or blocking progress?",
		"review.placeholder.next-steps": "What will be done before the next review?",
		"review.placeholder.achievements": "What has been achieved so far?",
		"review.placeholder.risks": "Which risks need active attention?",
		"review.placeholder.adjustments": "What should change in scope, priority, or execution?",
		"review.placeholder.decisions": "Record the decisions and owners.",
		"review.placeholder.outcomes": "Compare final outcomes with the original intent.",
		"review.placeholder.worked": "Which practices or choices worked well?",
		"review.placeholder.did-not-work": "What failed or created avoidable friction?",
		"review.placeholder.lessons": "What should be learned and retained?",
		"review.placeholder.follow-ups": "List concrete follow-up actions and owners.",
		"modals.reviews.title": "Period reviews",
		"modals.reviews.period": "Period",
		"modals.reviews.createTitle": "Create {type} · {period}",
		"modals.reviews.editTitle": "Edit {type} · {period}",
		"modals.reviews.reviewDate": "Review date",
		"modals.reviews.snapshotNotice": "A read-only snapshot of the current OKR progress and health will be captured when this review is created.",
		"modals.reviews.readOnly": "This period is closed or archived. Existing reviews can be opened but not changed.",
		"modals.reviews.empty": "No reviews have been created for this period.",
		"modals.reviews.summary": "{date} · {count} objectives",
		"modals.reviews.deleteTitle": "Delete period review",
		"modals.reviews.deleteConfirm": "Move this review to the trash? Its captured snapshot will be removed with it.",
		"modals.closePeriod.missingRetrospectiveWarning": "This period does not have a retrospective yet.",
		"modals.closePeriod.missingRetrospectiveTitle": "Close without a retrospective?",
		"modals.closePeriod.missingRetrospectiveConfirm": "A retrospective is recommended before closing a period. Close anyway and explicitly skip it?",
		"notices.reviewSaved": "Saved period review",
		"notices.reviewDeleted": "Deleted period review",
		"errors.invalidReviewDate": "The review date is invalid",
		"errors.invalidReviewType": "The period review type is invalid",
		"errors.incompleteReview": "Complete all required review sections before saving",
		"errors.reviewNotFound": "Period review not found: {id}",
		"errors.reviewFileMissing": "Period review file not found: {path}",
		"errors.missingRetrospectiveConfirmationRequired": "Explicit confirmation is required to close a period without a retrospective",
	},
	"zh-CN": {
		...
		"actions.open": "打开",
		"actions.periodReviews": "周期回顾",
		"actions.writeRetrospective": "撰写周期复盘",
		"actions.createReview.weekly": "新建周回顾",
		"actions.createReview.mid-cycle": "新建中期评审",
		"actions.createReview.retrospective": "新建周期复盘",
		"common.listSeparator": "、",
		"detail.weight": "权重 / 占比",
		"detail.health": "健康度",
		"modals.fields.weight": "相对权重",
		"modals.input.weightError": "权重必须是大于 0 的数字",
		"health.weightShort": "权重",
		"health.noRiskSignals": "当前没有风险信号",
		"health.status.on-track": "健康",
		"health.status.at-risk": "有风险",
		"health.status.off-track": "已偏离",
		"health.status.not-applicable": "不适用",
		"health.reason.behind-schedule": "实际进度落后于时间计划",
		"health.reason.medium-confidence": "信心度为中等",
		"health.reason.low-confidence": "信心度较低",
		"health.reason.blocked": "最近一次进度记录存在阻碍",
		"health.reason.on-hold": "工作处于暂停状态",
		"health.reason.overdue": "已超过截止日期",
		"review.type.weekly": "周回顾",
		"review.type.mid-cycle": "中期评审",
		"review.type.retrospective": "周期复盘",
		"review.section.summary": "摘要",
		"review.section.wins": "本周进展",
		"review.section.blockers": "阻碍因素",
		"review.section.next-steps": "下一步",
		"review.section.achievements": "阶段成果",
		"review.section.risks": "风险",
		"review.section.adjustments": "调整方案",
		"review.section.decisions": "评审决策",
		"review.section.outcomes": "最终结果",
		"review.section.worked": "有效做法",
		"review.section.did-not-work": "未奏效之处",
		"review.section.lessons": "经验教训",
		"review.section.follow-ups": "后续行动",
		"review.placeholder.summary": "概括当前状态与关键背景。",
		"review.placeholder.wins": "本周取得了哪些有意义的进展？",
		"review.placeholder.blockers": "哪些问题正在拖慢或阻碍进展？",
		"review.placeholder.next-steps": "下次回顾前将完成哪些事项？",
		"review.placeholder.achievements": "截至目前取得了哪些阶段成果？",
		"review.placeholder.risks": "哪些风险需要重点关注？",
		"review.placeholder.adjustments": "范围、优先级或执行方式应如何调整？",
		"review.placeholder.decisions": "记录评审结论、责任人与约定。",
		"review.placeholder.outcomes": "对照最初目标总结最终结果。",
		"review.placeholder.worked": "哪些方法或决策被证明有效？",
		"review.placeholder.did-not-work": "哪些做法失败或造成了不必要的阻力？",
		"review.placeholder.lessons": "有哪些经验值得沉淀和复用？",
		"review.placeholder.follow-ups": "列出具体后续行动与责任人。",
		"modals.reviews.title": "周期回顾",
		"modals.reviews.period": "周期",
		"modals.reviews.createTitle": "新建{type} · {period}",
		"modals.reviews.editTitle": "编辑{type} · {period}",
		"modals.reviews.reviewDate": "回顾日期",
		"modals.reviews.snapshotNotice": "创建回顾时会保存当前 OKR 进度与健康度的只读快照，后续编辑不会改写该快照。",
		"modals.reviews.readOnly": "该周期已关闭或归档，只能打开已有回顾，不能修改。",
		"modals.reviews.empty": "该周期尚未创建任何回顾。",
		"modals.reviews.summary": "{date} · {count} 个目标",
		"modals.reviews.deleteTitle": "删除周期回顾",
		"modals.reviews.deleteConfirm": "将该回顾移入回收站吗？其中保存的快照也会一并删除。",
		"modals.closePeriod.missingRetrospectiveWarning": "该周期尚未完成周期复盘。",
		"modals.closePeriod.missingRetrospectiveTitle": "不做复盘直接关闭？",
		"modals.closePeriod.missingRetrospectiveConfirm": "建议在关闭周期前完成复盘。确定显式跳过复盘并继续关闭吗？",
		"notices.reviewSaved": "已保存周期回顾",
		"notices.reviewDeleted": "已删除周期回顾",
		"errors.invalidReviewDate": "回顾日期无效",
		"errors.invalidReviewType": "周期回顾类型无效",
		"errors.incompleteReview": "请完成所有必填回顾字段后再保存",
		"errors.reviewNotFound": "找不到周期回顾：{id}",
		"errors.reviewFileMissing": "找不到周期回顾文件：{path}",
		"errors.missingRetrospectiveConfirmationRequired": "未完成周期复盘时，必须明确确认跳过后才能关闭周期",
	},
};
